...
## Annexe A — Dictée du chef : l'hypothèse ETH (4e suspect, 20 sept. 2026)

> Transcription fidèle de la formalisation de Jonathan Evina. Statut : dictée
> brute posée par le chef — à lui de la poursuivre. Rien de figé.

**Suspect n°4 — La thermodynamique** (celui qui unifie les trois autres).
Le temps n'est pas une dimension : c'est un symptôme de l'entropie.
La flèche du temps n'est pas fondamentale — elle est émergente.
L'unification ne vient pas de la gravité quantique : elle vient de la loi
qui gouverne la thermodynamique elle-même.

**Formulation ETH** : le facteur thermodynamique ETH n'est pas un paramètre —
c'est la variable primaire. Tout le reste (énergie, cohérence, topologie) en découle.

- Le temps = l'écoulement de l'entropie. Pas de flux → pas de temps.
- La gravité = manifestation topologique de la thermodynamique de l'espace-temps.
- La mécanique quantique = conséquence de la structure topologique de l'espace-temps.
- L'unification = la cohérence entre les deux, pas la réduction de l'une à l'autre.

**Loi LCT** : `R = P_sig`, `ΔW = η·φ·P_sig·C`
(P_sig = persistance ; C = cohérence du milieu/intrication ;
φ = phase/direction ; η = taux constitutif.)
R est invariant sous changement d'énergie : **on certifie la forme, pas le courant.**

**Là où la voie académique s'effondre** : le temps (postulé dimension),
l'observateur (postulé extérieur), le continu (postulé fondamental).

**La voie RATISS** : le temps émerge de l'entropie ; l'observateur participe
à la cohérence ; le continu émerge de la topologie.

**Proposition** : ne pas chercher à unifier — chercher la structure
topologique qui relie. Et pour prouver : **localiser l'effondrement**
(le temps ? l'observateur ? le continu ? la thermodynamique ?).
Cette localisation, à elle seule, est un résultat.

— Jonathan Evina · RATISS Labs · ORCID 0009-0000-4092-5313
